...
export default function PlansBox({ plans }) {
  ...
  return (
    <div
      data-aos="fade-up"
      data-aos-delay="100"
      className="membership__box py-5 px-3 sm:p-9 bg-box box rounded-xl flex flex-row gap-10 items-start"
    >
      <div className="w-2/5">
        {/* plans */}
      ...
      <div className="w-3/5 flex flex-col gap-10 items-start">
        {/* months */}
        ...
        {activePlan == 0 ? (
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="flex-1 font-semibold text-primary opacity-80 text-base sm:text-lg">
                2 visits, 1 hr 45 mins each ($350 value, brought to you for
                $245)
              </span>
            </div>
          </div>
